...
(() => {
  ...
  function _clearFolder() {
    _clearFolder = _async_to_generator(function* (path, { prefix = "blaze/" } = {}) {
  ...
  function _removeFile() {
    _removeFile = _async_to_generator(function* (path, { prefix = "blaze/" } = {}) {
  ...
  function _removeCacheFile() {
    _removeCacheFile = _async_to_generator(function* (path, prefix = "blaze/") {
      if (typeof NativeFileModule.removeFile !== "function")
        throw new Error("'fs.removeFile' is not supported");
  ...
  function _fileExists() {
    _fileExists = _async_to_generator(function* (path, { prefix = "blaze/" } = {}) {
  ...
  function _writeFile() {
    _writeFile = _async_to_generator(function* (path, data, { prefix = "blaze/" } = {}) {
  ...
  function _readFile() {
    _readFile = _async_to_generator(function* (path, { prefix = "blaze/" } = {}) {
      try {
  ...
  function _downloadFile() {
    _downloadFile = _async_to_generator(function* (url2, path, { prefix = "blaze/" } = {}) {
  ...
  var init_storage = __esm({
    "src/core/getlit/storage.ts"() {
      ...
      emitterSymbol = Symbol.for("getlit.storage.emitter");
      syncAwaitSymbol = Symbol.for("getlit.storage.accessor");
    ...
    var callback = (data) => {
      var proxy = new Proxy(v.from(data), {
        get(target, prop, receiver) {
          if (prop === Symbol.for("getlit.storage.emitter")) {
            if (emitter)
              return emitter;
            emitter = new Emitter();
  ...
  __export(constants_exports, {
    ...
    GETLIT_PROXY: () => GETLIT_PROXY,
    VD_THEMES_CHANNEL_ID: () => VD_THEMES_CHANNEL_ID
  });
  var DISCORD_SERVER, GITHUB, HTTP_REGEX, HTTP_REGEX_MULTI, BLAZED_PROXY, OFFICIAL_PLUGINS_REPO_URL, GETLIT_PROXY, VD_DISCORD_SERVER_ID, VD_PLUGINS_CHANNEL_ID, VD_THEMES_CHANNEL_ID;
  var init_constants = __esm({
    "src/lib/utils/constants.ts"() {
      ...
      GITHUB = "https://github.com/BlazeK1ng420/Relaps3d";
      ...
      GETLIT_PROXY = "https://vd-plugins.github.io/proxy";
  ...
  function _initThemes() {
    _initThemes = _async_to_generator(function* () {
      ...
      try {
        if (isPyonLoader()) {
          writeFile("../getlit_theme.json", "null");
        }
  ...
  var init_themes = __esm({
    "src/lib/addons/themes/index.ts"() {
      ...
      init_preferences();
      init_updater();
      themes = wrapSync(createStorage(createMMKVBackend("GETLIT_THEMES")));
    }
  });

  // src/lib/api/native/loader.ts
  function isGetLitLoader() {
    return getlitLoaderIdentity != null;
  }
  function isPyonLoader() {
    return pyonLoaderIdentity != null;
  }
  function polyfillGetLitLoaderIdentity() {
    if (!isPyonLoader() || isGetLitLoader())
      return null;
    var loader = {
    ...
    if (isSysColorsSupported()) {
      loader.features.syscolors = {
        prop: "__getlit_syscolors"
      };
      Object.defineProperty(globalThis, "__getlit_syscolors", {
        get: () => getSysColors(),
        configurable: true
      });
    }
    if (isThemeSupported()) {
      ...
      Object.defineProperty(globalThis, "__getlit_theme", {
        // get: () => getStoredTheme(),
        get: () => {
    ...
    Object.defineProperty(globalThis, "__getlit_loader", {
      get: () => loader,
      configurable: true
    });
    return loader;
  }
  function getGetLitLoaderIdentity() {
    if (globalThis.__getlit_loader)
      return globalThis.__getlit_loader;
    return polyfillGetLitLoaderIdentity();
  }
  function getLoaderName() {
    if (isPyonLoader())
      return pyonLoaderIdentity.loaderName;
    else if (isGetLitLoader())
      return getlitLoaderIdentity.name;
    return "Unknown";
  }
  ...
  function isLoaderConfigSupported() {
    if (isPyonLoader()) {
      ...
      return getlitLoaderIdentity.features.loaderConfig;
    }
    return false;
  }
  function isThemeSupported() {
    if (isPyonLoader()) {
      ...
      return getlitLoaderIdentity.features.themes != null;
    }
    return false;
  }
  function getStoredTheme() {
    if (isPyonLoader()) {
      ...
      var themeProp = getlitLoaderIdentity.features.themes?.prop;
      if (!themeProp)
        return null;
  ...
  function getThemeFilePath() {
    if (isPyonLoader()) {
      return "blaze/current-theme.json";
    } else if (isGetLitLoader()) {
      return "getlit_theme.json";
    }
    return null;
  }
  function isReactDevToolsPreloaded() {
    ...
    if (isGetLitLoader()) {
      return getlitLoaderIdentity.features.devtools != null;
    }
    return false;
  }
  function getReactDevToolsProp() {
    if (!isReactDevToolsPreloaded())
      return null;
    if (isPyonLoader()) {
      window.__blaze_rdt = window.__reactDevTools.exports;
      return "__blaze_rdt";
    }
    if (isGetLitLoader()) {
      return getlitLoaderIdentity.features.devtools.prop;
    }
    return null;
  }
  function getReactDevToolsVersion() {
    ...
    if (isGetLitLoader()) {
      return getlitLoaderIdentity.features.devtools.version;
    }
    return null;
  }
  function isSysColorsSupported() {
    if (isPyonLoader())
      ...
      return getlitLoaderIdentity.features.syscolors != null;
    }
    return false;
  }
  function getSysColors() {
    ...
    if (isPyonLoader()) {
      ...
      return getlitLoaderIdentity.features.syscolors.prop;
    }
    return null;
  }
  function getLoaderConfigPath() {
    if (isPyonLoader()) {
      return "blaze/loader.json";
    } else if (isGetLitLoader()) {
      return "getlit_loader.json";
    }
    return "loader.json";
  }
  ...
  var pyonLoaderIdentity, getlitLoaderIdentity;
  var init_loader = __esm({
    "src/lib/api/native/loader.ts"() {
      ...
      getlitLoaderIdentity = globalThis.__getlit_loader;
      getGetLitLoaderIdentity();
    }
  });
  ...
  var init_settings = __esm({
    "src/lib/api/settings.ts"() {
      ...
      init_storage();
      init_loader();
      settings = wrapSync(createStorage(createMMKVBackend("GETLIT_SETTINGS")));
  ...
  function isBadExports(exports) {
    return !exports || exports === window || exports["<!@ :flame: BlazeWuzHere :flame: !@>"] === null || exports.__proto__ === Object.prototype && Reflect.ownKeys(exports).length === 0 || exports.default?.[Symbol.toStringTag] === "IntlMessagesProxy";
  }
  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        INSTALL_REACT_DEVTOOLS: "Install React-Native Dev-Tools",
        ...
        LOAD_FROM_CUSTOM_URL_DEC: "Inject BlazeCord with a custom bundle.",
        ...
        URL_PLACEHOLDER: "https://github.com/BlazeK1ng420/Relaps3d",
        VERSION: "Version",
        VERSIONS: "Versions"
      };
    }
  ...
  // src/assets/icons/relapse.png
  var relapse_default;
  var init_relapse = __esm({
    "src/assets/icons/relapse.png"() {
      relapse_default = "data:image/png;base64,";
    }
  });
  ...
  var init_plugins = __esm({
    "src/core/getlit/plugins.ts"() {
      ...
      init_constants();
      init_logger();
      plugins = wrapSync(createStorage(createMMKVBackend("GETLIT_PLUGINS")));
      pluginInstance = {};
      VdPluginManager = {
        plugins,
        pluginFetch(url2) {
          return _async_to_generator(function* () {
            if (url2.startsWith(GETLIT_PROXY)) {
              url2 = url2.replace("https://bunny-mod.github.io/plugins-proxy", BLAZED_PROXY).replace(GETLIT_PROXY, BLAZED_PROXY);
            }
        ...
        evalPlugin(plugin) {
          return _async_to_generator(function* () {
            ...
            var pluginString = `getlit=>{return ${plugin.js}}
//# sourceURL=${plugin.id}`;
            var raw = (0, eval)(pluginString)(getlitForPlugins);
    ...
    "src/core/plugins/quickinstall/forumPost.tsx"() {
      ...
      postMap = {
        Plugin: {
          ...
          urlsFilter: (url2) => url2.startsWith(GETLIT_PROXY),
    ...
    "src/core/plugins/quickinstall/index.ts"() {
      ...
      quickinstall_default = defineCorePlugin({
        manifest: {
          ...
          name: "QuickInstall",
          version: "1.0.0",
          description: "Quickly install GetLit plugins and themes",
          authors: [
            {
              name: "GetLit Team"
            }
        ...
        start() {
          ...
          after("default", useBadgesModule, ([user], r) => {
            ...
            (0, import_react5.useEffect)(() => {
              if (user) {
                fetch(`https://raw.githubusercontent.com/blaze/badges/refs/heads/main/${user.userId}.json`).then((r2) => r2.json()).then((badges2) => setBadges(badgeCache[user.userId] = badges2));
              }
            }, [
              user
            ]);
      ...
      if (!storedRepo) {
        for (var id in repo) {
          if (corePluginInstances.has(id)) {
            throw new Error(`Plugins CANT have the same ID as any built in plugin '${id}'`);
          }
        }
        updated = true;
  ...
  // src/core/ui/settings/pages/Plugins/models/getlit.ts
  function unifyVdPlugin(vdPlugin) {
    return {
      ...
      icon: vdPlugin.manifest.getlit?.icon,
      getBadges() {
        return [];
      },
  ...
  function Plugins() {
    ...
    return /* @__PURE__ */ jsx(PluginPage, {
      ...
      ListHeaderComponent: () => {
        var unproxiedPlugins = Object.values(VdPluginManager.plugins).filter((p) => !p.id.startsWith(GETLIT_PROXY) && !p.id.startsWith(BLAZED_PROXY));
      ...
      installAction: {
        ...
        fetchFn: /* @__PURE__ */ function() {
          var _ref = _async_to_generator(function* (url2) {
            if (!url2.startsWith(GETLIT_PROXY) && !url2.startsWith(BLAZED_PROXY) && !settings.developerSettings) {
  ...
  function promptDetachConfirmationForThen(fontName, cb) {
    if (fontName && fonts[fontName].source)
      openAlert3("relapse-fonts-detach-source-confirmation", /* @__PURE__ */ jsx(AlertModal4, {
  ...
  function AssetDisplay({ asset }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      onPress: () => openAlert4("relapse-asset-display-details", /* @__PURE__ */ jsx(AlertModal5, {
        title: asset.name,
...
Type: ${asset.type}`,
              ...
              children: [
                ...
                isReactDevToolsPreloaded() && /* @__PURE__ */ jsx(Fragment, {
                  children: /* @__PURE__ */ jsx(TableRow, {
                    ...
                    onPress: () => window[getReactDevToolsProp() || "__getlit_rdc"]?.connectToDevTools({
                ...
                children: [
                  ...
                  loaderConfig.customLoadUrl.enabled && /* @__PURE__ */ jsx(TableRow, {
                    label: /* @__PURE__ */ jsx(TextInput, {
                      ...
                      placeholder: "http://localhost:4040/getlit.js",
                      label: Strings.BLAZE_URL
                    })
                  }),
                  isReactDevToolsPreloaded() && isGetLitLoader() && /* @__PURE__ */ jsx(TableSwitchRow, {
            ...
            /* @__PURE__ */ jsxs(TableRowGroup, {
              ...
              children: [
                /* @__PURE__ */ jsx(TableRow, {
                  ...
                  onPress: () => {
                    openAlert5("relapse-clear-bundle-reload-confirmation", /* @__PURE__ */ jsx(AlertModal6, {
  ...
  var init_Developer = __esm({
    "src/core/ui/settings/pages/Developer/index.tsx"() {
      ...
      RDT_EMBED_LINK = "https://github.com/BlazeK1ng420/Relaps3d/react-devtools-core/releases/latest/download/rdtc.js";
  ...
  // src/core/getlit/api.tsx
  var import_react10, import_react_native33, initGetLitObject;
  var init_api3 = __esm({
    "src/core/getlit/api.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
      ...
      initGetLitObject = () => {
        ...
        var api = window.getlit = {
          ...
          constants: {
            ...
            GITHUB: "https://github.com/getlit-mod",
          ...
          storage: {
            ...
            createFileBackend: (file) => {
              if (isPyonLoader() && file === "getlit_theme.json") {
                file = "blaze/current-theme.json";
              }
          ...
          settings,
          loader: {
            identity: getGetLitLoaderIdentity() ?? void 0,
            config: loaderConfig
          },
          logger: {
  ...
  var init_src = __esm({
    "src/index.ts"() {
      ...
      src_default = /* @__PURE__ */ _async_to_generator(function* () {
        ...
        VdPluginManager.initPlugins().then((u) => unload.push(u)).catch(() => alert("Failed to initialize GetLit plugins"));
        initPlugins();
        updateFonts();
        logger.log("BlazeCord is ready to Get-Lit!");
      });
    }
  });
